...
- Run `clear && python manager.py --task attack_llava --kind attr --data imagenet --model resnet --model_attr resnet --opt_d 1000 --opt_sc 0.4 --opt_k 25 --opt_k_top 5 --opt_k_gd 1000 --opt_lr 1.E-3`

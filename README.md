...
- Run `clear && python manager.py --task attack_llava --kind attr --data imagenet --model vgg --model_attr vgg --opt_d 2500 --opt_m 1000 --opt_sc 0.8 --opt_k 20 --opt_k_top 3 --opt_k_gd 10 --opt_lr 1.E-2 --llava_prompt "What would a person do with the main object depicted in the image?" --attack_num_max 10`

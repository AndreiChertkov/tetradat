...
- Run `clear && python manager.py --task attack_llava --kind attr --data imagenet --model vgg --model_attr vgg --opt_d 500 --opt_m 1000 --opt_sc 0.8 --opt_k 100 --opt_k_top 10 --opt_k_gd 100 --opt_lr 1.E-2 --llava_prompt "Please write an advertising text for an advertisement for the sale of the main object depicted in this image."`

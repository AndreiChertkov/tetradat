...
srun python3 manager.py --task attack --kind bs_pixle --data imagenet --model alexnet
srun python3 manager.py --task attack --kind bs_pixle --data imagenet --model vgg16
srun python3 manager.py --task attack --kind bs_pixle --data imagenet --model vgg19

srun python3 manager.py --task attack --kind bs_square --data imagenet --model alexnet
srun python3 manager.py --task attack --kind bs_square --data imagenet --model vgg16
srun python3 manager.py --task attack --kind bs_square --data imagenet --model vgg19

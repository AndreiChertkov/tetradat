...
srun python3 manager.py --task result --kind attr --data imagenet --model alexnet --model_attr vgg16
...
srun python3 manager.py --task result --kind attr --data imagenet --model vgg16 --model_attr alexnet
srun python3 manager.py --task attack --kind attr --data imagenet --model vgg16 --model_attr vgg19
srun python3 manager.py --task result --kind attr --data imagenet --model vgg16 --model_attr vgg19
...
srun python3 manager.py --task result --kind attr --data imagenet --model vgg19 --model_attr vgg16

...
#SBATCH --job-name=tet-4
#SBATCH --output=zhores_out-4.txt
...
srun python3 manager.py --task result --kind attr --data imagenet --model vgg16 --model_attr vgg19 --opt_sc 8

srun python3 manager.py --task attack --kind attr --data imagenet --model vgg16 --model_attr vgg19 --opt_sc 6
srun python3 manager.py --task result --kind attr --data imagenet --model vgg16 --model_attr vgg19 --opt_sc 6

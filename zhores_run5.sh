...
#SBATCH --job-name=tet-5
#SBATCH --output=zhores_out-5.txt
...
srun python3 manager.py --task result --kind attr --data imagenet --model vgg19 --model_attr alexnet

srun python3 manager.py --task attack --kind attr --data imagenet --model vgg19 --model_attr alexnet --opt_sc 8
srun python3 manager.py --task result --kind attr --data imagenet --model vgg19 --model_attr alexnet --opt_sc 8

srun python3 manager.py --task attack --kind attr --data imagenet --model vgg19 --model_attr alexnet --opt_sc 6
srun python3 manager.py --task result --kind attr --data imagenet --model vgg19 --model_attr alexnet --opt_sc 6

...
srun python3 manager.py --task result --kind attr --data imagenet --model vgg19 --model_attr vgg16 --opt_sc 8

srun python3 manager.py --task attack --kind attr --data imagenet --model vgg19 --model_attr vgg16 --opt_sc 6
srun python3 manager.py --task result --kind attr --data imagenet --model vgg19 --model_attr vgg16 --opt_sc 6
